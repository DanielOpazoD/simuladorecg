...
## Aspiraciones conservadas para después

Regionalizar T, acoplar cambios de despolarización a lesión, calibrar fases frente a registros seriados y ampliar validación con datos independientes son objetivos razonables. Esta entrega prepara su base: etiquetas honestas, controles completos, límites explícitos y medición consistente. No incorpora nuevos módulos, diagnósticos automáticos, puntuaciones, derivaciones, escenarios terapéuticos ni una simulación de reperfusión continua.
